...
L1 = 0.01    # L1 regularization, larger value means more regularized
L2 = 0.5#1.     # L2 regularization, larger value means more regularized

# LUIS: NEW PARAMETERS TO ADJUST THE LOGLOSS

gamma = 5#0.995#0.995#0.92#0.01#0.92
delta = 0.005#0.005#0.08#0.99#0.08

# C, feature/hash trick
D = 2 ** 20#2 ** 20             # number of weights to use
interaction = False #False     # whether to enable poly2 feature interactions
